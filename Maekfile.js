...
const server_names = [
	maek.CPP('maze-server.cpp'),
	maek.CPP('Scoreboard.cpp'),
];

const common_names = [
	maek.CPP('DrawStuff.cpp'),
	maek.CPP('ColorProgram.cpp'),
	maek.CPP('ColorTextureProgram.cpp'),

	maek.CPP('Font.cpp'),
	maek.CPP('DistanceTextProgram.cpp'),
...
const server_exe = maek.LINK([...server_names, ...common_names], 'dist/maze-server');

//set the default target to the game (and copy the readme files):
maek.TARGETS = [server_exe, ...copies];
